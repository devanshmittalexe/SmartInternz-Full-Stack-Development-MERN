    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300">
              Your one-stop destination for premium tech products that enhance your lifestyle.
            </p>
          </div>
          ...
          <div>
            ...
            <form className="mt-4 flex">
              ...
              />
              <button className="bg-blue-600 px-4 py-2 rounded-r font-medium hover:bg-blue-700">
                Subscribe
              </button>
            </form>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-300">
          <p>© {new Date().getFullYear()} MittalPeripherals. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
